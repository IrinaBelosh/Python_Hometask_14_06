...
items = int(input('Enter the number of plants: '))
items_yield = [int(input('Enter the yield of the plant: ')) for i in range(items)]
# print(items_yield)

summ = 0
temp_list = []
for i in range(len(items_yield)):
    summ = items_yield[i - 2] + items_yield[i - 1] + items_yield[i]
